/**
 * JstreeFootermenuController - Footer menu tree browser
 *
 * Manages the footer menu structure using jsTree 3.x.
 * Types: root, submenu only (simpler than main menu).
 */
import JstreeBaseController from "./jstree-base-controller.js"

export default class extends JstreeBaseController {
    getDeleteEventName() {
        return 'footermenuTreeDeleted'
    }

    getErrorEventName() {
        return 'footermenuTreeError'
    }
    ...
    getJstreeConfig() {
        return {
            ...
            types: {
                ...
                'root': { icon: 'jstree-folder', valid_children: ['submenu'] },
