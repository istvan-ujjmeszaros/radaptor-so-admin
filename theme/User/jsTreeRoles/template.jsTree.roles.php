...
<div class="box">
	...
	<div style="float:left;overflow:auto;width:530px;height:90%;margin-left:10px;">
		<h3><i><?= e($this->strings['admin.menu.roles']) ?></i></h3>
		<br/>

		<div id="<?= e($jstreeId); ?>" style="margin:15px 0;"
			 data-controller="jstree-roles"
			 data-jstree-roles-jstree-id-value="<?= e($jstreeId); ?>"
			 data-jstree-roles-ajax-url-value="<?= e($ajaxUrl); ?>Load"
			 data-jstree-roles-move-url-value="<?= e($ajaxUrl); ?>Move"
			 data-jstree-roles-detail-url-value="<?= e($ajaxUrl); ?>DinaContent"
			 data-jstree-roles-delete-url-value="<?= e($ajaxUrl); ?>DeleteRecursive">
		</div>
	</div>
	<br/>
	<br/>
